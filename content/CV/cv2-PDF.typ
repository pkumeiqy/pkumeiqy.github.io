...
Born In June,2005 | Male | College Of Engineering,Peking University",
  contacts: (
    [#link("pkumqy@foxmail.com")[Email: pkumqy\@foxmail.com]],
    // [#link("https://chaoticgood.computer")[Website]],
    [#link("https://github.com/satopikac")[GitHub]],
    // [#link("+86 1881077 3110")[Telephone ]],
  ),
...
#skills((
  ...
  ("Languages (partial list)", (
   ...
   ("English Level", (
    [National College English Test Band 6 Score: 555],
    // [C Language],
    // [MatLab],
    // //[Punch Cards],
    //  [Python],
...
//   ]
// )
#exp(role: "Project Participant",project: "SLAM of Wheeled Robots 
with Collaborative Robotic Arm Grasping",
date: "2024-2025",
details: [
...
= Research Interests
AI + Robotics, including Embodied Intelligence, VLA (Vision-Language-Action), Multimodal Fusion, and Multi-Robot Collaboration.
/*
